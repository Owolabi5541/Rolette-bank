...
<div>
    <div class="bg-blue-500 px-4 py-4">
      ...
      <div
        ...
        <a href="#">
            <img src="{{ asset('images/logowhite.svg') }}" alt="Logo">
            </a>
        <div class="flex justify-between items-center">
          ...
          <div
            ...
            <a href="/login"
            class="inline-block py-2 px-4 text-white hover:text-gray-700 hover:bg-white rounded-lg"
            >Login</a>
          </div>
        </div>
        ...
        <div>
          <div class="hidden md:block">
            <a
              href="#"
              class="inline-block py-1 md:py-4 text-white mr-6 font-bold"
              >How it Works</a
            >
            <a
              href="#"
              class="inline-block py-1 md:py-4 text-white hover:text-gray-300 mr-6"
              >Services</a
            >
            <a
              href="#"
              class="inline-block py-1 md:py-4 text-white hover:text-gray-300"
              >Blog</a
            >
          </div>
        </div>
    ...
    <div class="bg-blue-500 md:overflow-hidden">
        ...
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              ...
              <a
                href="{{ route('register') }}"
                class="mt-6 mb-12 md:mb-0 md:mt-10 inline-block py-3 px-8 text-white bg-green-500 hover:bg-green-600 rounded-lg shadow"
                >Get Started</a
              >
            </div>
            <div class="md:w-1/2 relative">
              <div class="hidden md:block">
                ...
                >
                  <div
                    class="bg-blue-500 mx-auto rounded-lg px-2 pb-2 relative mb-8"
                  >
                    <div class="mb-1">
                      <span
                    ...
                    <div
                      class="-mr-2 -mb-4 absolute bottom-0 right-0 h-16 w-10 rounded-lg bg-green-600 border-2 border-white"
                    ></div>
                    <div
                ...
                >
                  <div
                    class="bg-blue-500 mx-auto rounded-lg relative mb-8 py-2 w-20 border-2 border-white"
                  >
                    <div
                      class="h-8 bg-green-600 w-8 rounded absolute left-0 top-0 -mt-3 ml-4"
                    ...
                    <div
                      class="flex items-center justify-center h-6 bg-blue-500 w-6 rounded-l-lg ml-auto border-4 border-white -mr-1"
                    >
                      <div
                        class="h-2 w-2 rounded-full bg-blue-500 border-2 border-white"
                      ></div>
                    </div>

                    <div
                      class="w-8 h-8 bg-green-600 border-4 border-white rounded-full -ml-3 -mb-5"
                    ></div>
                  </div>
                ...
                >
                  <div
                    class="bg-blue-500 mx-auto rounded-lg pt-4 mb-16 relative"
                  >
                    ...
                    <div class="text-right my-2 pb-1">
                      ...
                      ></div>
                      <div
                        class="inline-flex w-3 h-3 rounded-full bg-blue-500 border-2 border-white mr-2"
                      ></div>
                    </div>

                    <div
                      class="-ml-4 -mb-6 absolute left-0 bottom-0 w-16 bg-green-600 mx-auto rounded-lg pb-2 pt-3"
                    >
              ...
              >
                ...
                >
                  <span
                    class="h-2 w-2 rounded-full bg-green-500 inline-block mr-1 ml-2"
                  ></span>
                  <span
              ...
              >
                <div
                  class="bg-blue-500 mx-auto rounded-lg w-20 pt-3 mb-12 relative"
                >
