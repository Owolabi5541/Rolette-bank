...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex   w-full">
            ...
            <div class="container max-w-lg mx-auto mt-10 p-8 bg-gray-100 shadow-md rounded-lg">
    <div class="progress-bar mb-6">
      <div class="progress" id="progress"></div>
    </div>

    <form class="multi-step-form" id="form" method="POST" action="{{ route('register') }}">
        @csrf

        <fieldset class="step hidden">
        <h2 class="text-xl mb-4">Step 3</h2>
        <!-- Password -->
        <div class="mt-4">
           
        <div class="flex">
            <input id="otpcode" class="flex-1 appearance-none rounded-none rounded-l-md block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
            <input id="otpcode" class="flex-1 block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
            <input id="otpcode" class="flex-1 block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
            <input id="otpcode" class="flex-1 block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
            <input id="otpcode" class="flex-1 block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
            <input id="otpcode" class="flex-1 appearance-none rounded-none rounded-r-md block w-full border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-opacity-50 focus:ring-blue-500 sm:text-sm sm:leading-6 mb-5" maxlength="1" type="text" name="otpcode" required  />
        </div>
