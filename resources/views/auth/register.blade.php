...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    ...
    <form class="multi-step-form" id="form" method="POST" action="{{ route('register') }}">
        ...
        <fieldset class="step">
        <h2 class="text-xl mb-4">Step 1</h2>
        <!-- FirstName -->
        <div class="flex -mx-3">
        ...
        <div>
        <x-input-label for="userid" :value="__('*optional')" />
            <x-text-input id="userid" class="block mt-1 w-full " type="text" name="useriD" :value="old('userID')" autofocus autocomplete="userID" placeholder="UserID" />
        ...
        <button class="ml-4 next-button  hover:text-blue-500">
                {{ __('Next') }}
            </button>
        ...
        <h2 class="text-xl mb-4">Step 2</h2>
        <!-- Email Address -->
        <div class="mt-4">
        ...
        <div class="mt-4">
            ...
            <span id="valid-msg" class="hidden" style="color:green">Valid</span>
            ...
            <button class="prev-button mt-4 hover:text-blue-500 mr-4">
                {{ __('Previous') }}
            </button>

            <button class="next-button mt-5 hover:text-blue-500">
                {{ __('Next') }}
            </button>
        ...
        <div class="flex items-center mt-8">
           <button class="prev-button  hover:text-blue-500 mr-4">
                {{ __('Back') }}
            </button>
